...
public class PostController {
    ...
    public ResponseEntity<CommonResponse<List<PostListResponse>>> getAllPosts() {
        ...
        return ResponseEntity.ok(CommonResponse.ok("게시글 목록 조회 완료!", posts));
    }
    ...
    public ResponseEntity<CommonResponse<PostResponse>> getPost(
        ...
        return ResponseEntity.ok(CommonResponse.ok("게시글 단건 조회 완료!", post));
    }

    @Operation(summary = "게시글 수정", description = "게시글 ID로 특정 게시글을 수정합니다. 작성자 본인만 수정 가능합니다.")
    @ApiResponses({
    ...
    public ResponseEntity<CommonResponse<UpdatePostResponse>> updatePost(
        ...
        Long userId = Long.parseLong(authentication.getName());
        UpdatePostResponse response = postService.updatePost(userId, id, request);
        return ResponseEntity.ok(CommonResponse.ok("게시글 수정 완료!", response));
    }

    @Operation(summary = "게시글 삭제", description = "게시글 ID로 특정 게시글을 삭제합니다. 작성자 본인만 삭제 가능합니다.")
    @ApiResponses({
